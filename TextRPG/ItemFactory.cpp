...
ItemFactory::ItemFactory()
{
	...
	items.insert(make_pair("LowAttackPotion", new ConsumableItem("LowAttackPotion", 20, Rarity::C, EffectType::DamageUp, 30, 3)));
	items.insert(make_pair("MiddleAttackPotion", new ConsumableItem("MiddleAttackPotion", 40, Rarity::R, EffectType::DamageUp, 50, 5)));
	items.insert(make_pair("HightAttackPotion", new ConsumableItem("HightAttackPotion", 60, Rarity::SR, EffectType::DamageUp, 100, 7)));
	...
	// Attack Booster
	//items.insert(make_pair("AttackBooster", new ConsumableItem("AttackBooster", 200, Rarity::R, EffectType::DamageUp, 30, 3)));
