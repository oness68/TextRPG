...
namespace Enums
{
	...
	enum EnumPrintLog { ECharacter, EGoblin, EOrc, ETroll, EWolf, ESlime, EGoblinRider, ETwinHeadTroll, ETreant, EDragon, EBuff, EDeBuff, EShop, ERest, EBag };

	enum MonsterState{ EAttack=1,EDefence,EMonsterSkill};
